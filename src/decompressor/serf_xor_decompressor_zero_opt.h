#ifndef SERF_XOR_DECOMPRESSOR_ZERO_OPT_H_
#define SERF_XOR_DECOMPRESSOR_ZERO_OPT_H_
...
/**
 * Optimized Serf XOR Decompressor with Zero Sequence Optimization
 * 
 * This version handles the fourth state '11' for zero sequences encoded
 * with Elias Gamma encoding.
 * 
 * Four states:
 ...
 */
class SerfXORDecompressorZeroOpt {
 public:
  explicit SerfXORDecompressorZeroOpt(long adjust_digit) : adjust_digit_(adjust_digit) {};
...
#endif // SERF_XOR_DECOMPRESSOR_ZERO_OPT_H_
