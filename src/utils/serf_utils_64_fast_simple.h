#ifndef SERF_64_UTILS_FAST_SIMPLE_H
#define SERF_64_UTILS_FAST_SIMPLE_H

#include <cstdint>
#include "double.h"

/**
 * Simple Fast Approximator Search for Serf-XOR
 * 
 * This version limits the search iterations instead of generating candidates,
 * providing a good balance between speed and compression quality.
 */
class SerfUtils64FastSimple {
 public:
 ...
 private:
  ...
  // Maximum iterations to limit search time
  static constexpr int kMaxSearchIterations = 8; // Reduced from ~64 in original
...
#endif  // SERF_64_UTILS_FAST_SIMPLE_H
